...
CREATE TABLE IF NOT EXISTS payroll_calendar_config (
  ...
  incidences_access_start_at timestamptz NOT NULL DEFAULT now(),
  incidences_access_days integer NOT NULL DEFAULT 5,
  extras_access_start_at timestamptz NOT NULL DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS schedule_incidences (
  ...
  extra_hours_in_schedule numeric NOT NULL DEFAULT 0,
  updated_at timestamptz NOT NULL DEFAULT now(),
  updated_by uuid REFERENCES app_users(id),
...
CREATE TABLE IF NOT EXISTS payroll_lines (
  ...
  logged_extra_hours numeric NOT NULL DEFAULT 0,
  logged_extra_amount numeric NOT NULL DEFAULT 0,
  total_extra_hours numeric NOT NULL DEFAULT 0,
  total_extra_amount numeric NOT NULL DEFAULT 0,
