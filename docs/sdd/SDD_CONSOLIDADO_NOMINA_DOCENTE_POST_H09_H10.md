...
| H18 | H18-F1 backend y H18-F2 frontend implementados; H18-F5 deploy productivo ejecutado con smoke tecnico OK; smoke manual Excel/sesion real pendiente para cierre operativo. |
...
| Reportes operativos | `docs/specs/SPEC_H18_Reportes_Operativos.md`, `docs/auditoria/H18_Fase1_Backend_Reportes_Operativos.md`, `docs/auditoria/H18_Fase2_Frontend_Reportes_Operativos.md`, `docs/auditoria/H18_Fase3_Validacion_UI_Exportables_Reportes_Operativos.md` y `docs/auditoria/H18_Deploy_Productivo_Reportes_Operativos.md` | SDD consolidado, matriz, H11, H17 y rutas operativas | H18-F1/F2 implementados; H18-F5 desplegado con smoke tecnico OK; smoke manual por rol/Excel pendiente |
...
| H18 | Backend F1 y frontend F2 implementados / H18-F5 deploy productivo ejecutado / smoke tecnico OK | Completar smoke manual CSV/XLSX con sesion real, manteniendo guardas backend por rol, CSV H11 como respaldo y XLSX server-side con `exceljs`. |
