...
| H11 | Pendiente; inventario CSV/acento/codificacion creado. |
...
| CSV/codificacion | `docs/auditoria/H11_Inventario_CSV_Acentos_Codificacion.md` | Inventarios tecnicos previos con menciones CSV | Vigente para iniciar H11 |
...
| H11 | Pendiente activo | Implementar helper CSV central, BOM UTF-8 consistente y pruebas Excel/Sheets. |
