...
| Revision Cloud Run anterior / rollback inmediato | `nomina-api-00054-2ld` |
...
| H18 | Cerrado operativo en produccion previa; ajuste post-H23 implementado en local/test para quincena obligatoria, paridad temporal H23, sobrecarga real y consolidacion multicoordinacion. Predeploy/deploy pendientes. |
...
- H18 ajuste post-H23: implementado en local/test el 2026-09-10; exige quincena del ciclo activo, usa `source=auto`, calcula base neta con faltas y `0.5` horas por retardo, marca sobrecarga quincenal `70/50/30`, consolida carga semanal entre coordinaciones y limita ambas pestanas a Admin/Direccion/Coordinador. Sin migracion ni deploy en esta fase.
...
| Reportes operativos | `docs/specs/SPEC_H18_Reportes_Operativos.md`, `docs/auditoria/H18_Fase1_Backend_Reportes_Operativos.md`, `docs/auditoria/H18_Fase2_Frontend_Reportes_Operativos.md`, `docs/auditoria/H18_Fase3_Validacion_UI_Exportables_Reportes_Operativos.md`, `docs/auditoria/H18_Deploy_Productivo_Reportes_Operativos.md`, `docs/auditoria/H18_Fase6_UX_Filtros_Reportes_Operativos.md`, `docs/auditoria/H18_Hotfix_Reportes_Snapshot_LineKey.md`, `docs/auditoria/H18_Cierre_Operativo_Reportes_Operativos.md` y `docs/auditoria/H18_Ajuste_PostH23_Reportes_Operativos.md` | SDD consolidado, matriz, H11, H17, H20, H23 y rutas operativas | Version previa cerrada en produccion; ajuste post-H23 implementado local/test y pendiente de deploy controlado |
...
| H18 | Ajuste post-H23 local/test | Validar predeploy y desplegar de forma controlada la quincena obligatoria, paridad H23, consolidacion global y permisos Admin/Direccion/Coordinador; CSV H11 y XLSX server-side permanecen. |
