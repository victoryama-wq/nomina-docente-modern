...
Estado: preview tecnico ejecutado; bloqueantes presentes; apply no autorizado.
...
1. Resolver humanamente las cinco colisiones normalizadas mediante `id` y
   claves oficiales distintas, sin merge ni DELETE.
2. Validar el CSV institucional final con encabezado H21 exacto.
3. Resolver el hallazgo critico npm documentado en
   `SEC_H21_Triage_Npm_Audit_PreDeploy.md`.
