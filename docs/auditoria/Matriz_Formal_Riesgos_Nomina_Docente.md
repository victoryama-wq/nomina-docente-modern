...
- H18-F1 backend y H18-F2 frontend implementados para modulo Reportes Operativos; H18-F5 deploy productivo ejecutado con smoke tecnico OK; H18-F6 filtros amigables implementados localmente; smoke manual CSV/XLSX con sesion real pendiente para cierre operativo.
...
| H18 | Modulo Reportes Operativos desplegado; H18-F6 UX filtros pendiente de deploy | Reportes / Permisos / Operacion academica | H18-F1 backend y H18-F2 frontend implementados; H18-F5 deploy productivo ejecutado con smoke tecnico OK; H18-F6 filtros amigables implementados localmente | Bajo-medio: queda riesgo de validacion manual de exportables/roles, deploy H18-F6 y snapshot sin capturador historico externo | P2 monitoreo / cierre pendiente | Desplegar H18-F6 con H13 y completar smoke CSV/XLSX desde UI con sesion real y Excel institucional; no crear permisos ni migraciones sin H05 | Deploy H18-F6 ejecutado, healthchecks OK, smoke manual autorizado de roles/exportables aprobado | Si, solo si se agregan permisos nuevos o cambios de BD |
...
6. **H18 Reportes Operativos.** Backend F1 y frontend F2 ya implementados; H18-F5 deploy productivo ejecutado con smoke tecnico OK; H18-F6 mejora filtros amigables implementada localmente. Continuar con deploy H18-F6 y smoke manual CSV/XLSX con sesion real y Excel institucional para cierre operativo.
