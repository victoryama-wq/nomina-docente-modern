...
- H19 en validacion read-only: CSV `docentes.csv` normalizado fue regenerado contra Cloud SQL sin escrituras; SQL propuesto queda en ROLLBACK y requiere aprobacion antes de cualquier `UPDATE`.
