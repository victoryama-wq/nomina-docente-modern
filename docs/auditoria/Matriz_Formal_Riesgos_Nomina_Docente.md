...
| H11 | CSV y acentos/codificacion | Reportes / Excel / Importaciones | Inventariado; implementacion pendiente | Medio: reprocesos por acentos/mojibake | P2 Medio | Estandarizar UTF-8/BOM, helper central y pruebas Excel por exportable | Exportables criticos abren bien en Excel/Sheets/LibreOffice | Si: Finanzas valida formato |
...
1. **H11 - CSV, acentos y codificacion.** Siguiente fase activa para estabilizar exportables criticos.
